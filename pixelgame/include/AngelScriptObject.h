...
namespace max::angelscript
{
	...
	public:
        ...
        inline object(const char* typedecl, const char* filename, Args&& ...args) :
            type(max::angelscript::Engine::GetType(typedecl, filename))
        {
            asIScriptContext* ctx = max::angelscript::Engine::CreateContext();
        ...
        inline object(const char* typedecl, asIScriptModule* mod, Args&& ...args) :
            type(max::angelscript::Engine::GetType(typedecl, mod))
        {
            asIScriptContext* ctx = max::angelscript::Engine::CreateContext();
